...
public class Context {
    ...
    public void reg(Class cl) {
        ...
        if (constructors.length > 1) {
            throw new IllegalStateException("Class has multiple" +
                    " constructors : " + cl.getCanonicalName());
        }
        Constructor con = constructors[0];
        List<Object> args = new ArrayList<Object>();
        for (Class arg : con.getParameterTypes()) {
            if (!els.containsKey(arg.getCanonicalName())) {
                throw new IllegalStateException("Object doesn't found" +
                        " in context : " + arg.getCanonicalName());
            }
        ...
        try {
            ...
            throw new IllegalStateException("Coun't create an" +
                    " instance of : " + cl.getCanonicalName(), e);
        }
    }
